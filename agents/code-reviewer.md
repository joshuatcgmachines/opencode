...
- Use `superlocalmemory` when appropriate: recall relevant prior decisions/preferences before review, and remember durable review patterns or accepted tradeoffs.
