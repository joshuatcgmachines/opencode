...
- Use `superlocalmemory` when appropriate: recall relevant prior decisions/preferences before research, and remember durable research conclusions when they are likely to matter later.
