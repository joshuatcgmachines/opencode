...
- Use `superlocalmemory` when appropriate: recall relevant prior decisions/preferences before review, and remember durable security decisions or recurring risk patterns.
